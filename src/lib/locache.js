...
//      setting and retrieving values.
    ...
    var supportsNativeJSON = LocacheCache.prototype.supportsNativeJSON = !!JSON;
    ...
    LocacheCache.prototype.async = {
        ...
        set: function (key, value, seconds) {
            return new Promise.resolve(this.set(key, value, seconds));
        },

        get: function (key) {
            return new Promise.resolve(this.get(key));
        }
