...
.scroller-item {
  text-align: center;
  font-size: .42666667rem; // 32px; // 16px;
  height: .45333333rem; // 34px;
  line-height: .45333333rem; // 34px;
  color: #000;
}
...
.dp-header .dp-item {
  ...
  height: .58666667rem; // 44px;
  line-height: .58666667rem; // 44px;
  cursor: pointer;
}
